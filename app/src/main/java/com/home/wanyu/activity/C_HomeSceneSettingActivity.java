...
import com.home.wanyu.C_Model.C_HomeSceneSettingModel;
import com.home.wanyu.C_View.C_HomeSceneSettingView;
...
//修改情景
public class C_HomeSceneSettingActivity extends CMyActivity implements C_HomeSceneSettingView.SceneModelSelect {
    final int REQUESTCODE=100;
    final int RESULTCODE=200;
    final String RESULT="name";
    C_HomeSceneSettingView c_homeSceneSettingView;//view显示层
    C_HomeSceneSettingModel c_homeSceneSettingModel;//数据处理
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        c_homeSceneSettingView=new C_HomeSceneSettingView(this,this);
        c_homeSceneSettingModel=new C_HomeSceneSettingModel();
    }
    //提交按钮
    @Override
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode==REQUESTCODE){
            if (resultCode==RESULTCODE){
                ...
                if (pos==-1){
                    Log.e("C_HomeSceneSettingActiv","error:返回的情景图标的下表不正确");
                }
                else {
