...
public class HomeScenePagerItemListApdater extends BaseAdapter{
    ...
    public HomeScenePagerItemListApdater(List<Map<String,String>> list,Context context,MyFloatingView floatingView) {
        this.list = list;
    ...
    public View getView( int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            ...
            viewHodler.fragment_home_scene_viewpager_listitem_switch= (SwitchCompat) convertView.findViewById(R.id.fragment_home_scene_viewpager_listitem_switch);
        ...
        if ("0".equals(state)){
            viewHodler.fragment_home_scene_viewpager_listitem_switch.setChecked(false);
        }
        else if ("1".equals(state)){
            viewHodler.fragment_home_scene_viewpager_listitem_switch.setChecked(true);
        }
        viewHodler.fragment_home_scene_viewpager_listitem_switch.setTag(position);

        viewHodler.fragment_home_scene_viewpager_listitem_switch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
    ...
    class ViewHodler{
        ...
        SwitchCompat fragment_home_scene_viewpager_listitem_switch;
    }
