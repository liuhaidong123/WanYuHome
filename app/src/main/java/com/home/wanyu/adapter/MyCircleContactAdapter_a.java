 ...
 */
//活动的adapter
public class MyCircleContactAdapter_a extends BaseAdapter{
    List<Bean_AC.RowsBean> listCircle;
    private Context context;
    public MyCircleContactAdapter_a(List<Bean_AC.RowsBean>listCircle,Context context){
...
//                |categoryId     |Long      |Y    |分类编号
        ...
        hodler.circle_type_tv.setText(listCircle.get(position).getActivityTheme());//圈子没有标题
