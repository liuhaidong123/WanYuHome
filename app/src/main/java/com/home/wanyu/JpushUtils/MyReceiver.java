package com.home.wanyu.JpushUtils;
...
public class MyReceiver extends BroadcastReceiver{
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
            ...
            Toast.makeText(context,"MyReceiver--注册的jpId=="+regId,Toast.LENGTH_SHORT).show();

        } else if (JPushInterface.ACTION_MESSAGE_RECEIVED.equals(intent.getAction())) {
            String msg=bundle.getString(JPushInterface.EXTRA_MESSAGE);
            Log.d(TAG, "[MyReceiver] 接收到推送下来的自定义消息: " + msg);
            Toast.makeText(context,"MyReceiver--接收到推送消息=="+msg,Toast.LENGTH_SHORT).show();
        }
        else if (JPushInterface.ACTION_NOTIFICATION_RECEIVED.equals(intent.getAction()))
        {
            ...
            Toast.makeText(context,"MyReceiver--注册的jpId=="+notifactionId+"--标题--"+title+"--内容---"+alert,Toast.LENGTH_SHORT).show();
//
...
//            }
        ...
        else if (JPushInterface.ACTION_NOTIFICATION_OPENED.equals(intent.getAction()))
        {
            ...
            //打开自定义的Activity
            Intent i = new Intent(context, CircleGiveYouCommentActivity.class);
            i.putExtras(bundle);
